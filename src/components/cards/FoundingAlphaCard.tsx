...
export function FoundingAlphaCard({ 
  ...
  return (
    <motion.div
      className={`relative w-[340px] md:w-[420px] h-[220px] md:h-[270px] cursor-pointer mx-auto ${className}`}
      onMouseMove={handleMouseMove}
      onMouseLeave={handleMouseLeave}
      animate={{
        rotateX: rotateX + 15, // Base 15-degree angle
        rotateY,
        y: [0, -8, 0],
      }}
      transition={{
    ...
    >
      ...
      <div 
        className="absolute inset-0 rounded-2xl blur-3xl translate-y-6 scale-90"
        style={{
      ...
      >
        ...
        {/* Secondary Rim Light */}
        <div 
          className="absolute top-0 right-0 w-32 h-1"
          style={{
        ...
        <div className="relative z-10 p-6 md:p-8 h-full flex flex-col justify-between">
          ...
          <div className="flex items-end justify-between">
            <div className="space-y-2">
              ...
              <div>
                <p 
                  ...
                  style={{ color: 'rgba(160, 137, 44, 0.6)' }}
                >
                  Member ID
                </p>
                <p 
            ...
            {showQR && (
              <div 
                className="w-16 h-16 rounded-lg p-1.5"
                style={{
