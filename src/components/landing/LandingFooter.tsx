...
export default function LandingFooter() {
  return (
    <footer className="relative z-10 bg-[#0a0a0a] border-t border-gray-800/50">
      {/* Main Footer Content */}
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 lg:gap-12">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            >
              ...
              <p
                className="text-[10px] text-[#00FF41] uppercase tracking-[0.15em]"
        ...
        <div className="max-w-6xl mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-4">
              <a
                href="#"
                className="w-8 h-8 rounded-full border border-gray-800 flex items-center justify-center text-gray-500 hover:text-[#D4AF37] hover:border-[#D4AF37]/30 transition-all duration-200"
                aria-label="LinkedIn"
              >
