...
export default function LandingFooter() {
  return <footer className="relative z-10 bg-[#0a0a12] border-t border-gray-800">
      {/* Main Footer Content */}
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 lg:gap-12">
          ...
          <div className="col-span-2 md:col-span-1">
            <div className="flex items-center gap-3 mb-4">
              <img alt="ABC" className="w-10 h-10 rounded-full object-fill" src="/lovable-uploads/1c025da1-7656-4dea-a768-7467c297b4f1.png" />
              <div>
                <span className="text-xl font-bold text-[#D4AF37]" style={{
            ...
            <div className="flex items-center gap-3">
              {socialLinks.map(social => <a key={social.label} href={social.href} aria-label={social.label} className="w-9 h-9 rounded-full border border-gray-700 flex items-center justify-center text-gray-400 hover:text-[#D4AF37] hover:border-[#D4AF37]/50 transition-all duration-300">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {footerLinks.company.map(link => <li key={link.label}>
                  <a href={link.href} className="text-sm text-gray-400 hover:text-[#D4AF37] transition-colors duration-200">
                    {link.label}
                  </a>
                </li>)}
            </ul>
