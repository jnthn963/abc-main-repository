      ...
      >
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <Link to="/register">
            <Button 
              size="lg" 
              className="bg-[#00FF41] hover:bg-[#00FF41]/90 text-[#050505] font-bold text-sm uppercase tracking-[0.1em] px-8 py-6 shadow-lg shadow-[#00FF41]/20 transition-all duration-300 hover:shadow-[#00FF41]/40 group"
            >
              Get Started
        ...
        >
          <div className="text-center">
            <p className="text-2xl md:text-3xl font-bold text-[#D4AF37]" style={{ fontFamily: 'JetBrains Mono, monospace' }}>0.5%</p>
            <p className="text-xs text-gray-500 uppercase tracking-wider mt-1">Daily Yield</p>
          </div>
          <div className="text-center border-x border-gray-800">
            <p className="text-2xl md:text-3xl font-bold text-[#00FF41]" style={{ fontFamily: 'JetBrains Mono, monospace' }}>100%</p>
            <p className="text-xs text-gray-500 uppercase tracking-wider mt-1">Reserve Ratio</p>
          </div>
          <div className="text-center">
            <p className="text-2xl md:text-3xl font-bold text-white" style={{ fontFamily: 'JetBrains Mono, monospace' }}>24/7</p>
