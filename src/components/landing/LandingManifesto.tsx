...
export default function LandingManifesto() {
  return <section className="relative z-10 py-24 px-4 overflow-hidden">
      {/* Background Elements */}
      ...
      <div className="relative max-w-6xl mx-auto">
        ...
        ease: [0.25, 0.46, 0.45, 0.94]
          ...
          <div className="relative p-8 md:p-12 rounded-2xl border border-[#D4AF37]/20 bg-[#0a0a0a]/50 backdrop-blur-sm">
            ...
            duration: 0.6,
            delay: 0.2
          }} className="relative text-xl md:text-2xl lg:text-3xl italic text-center leading-relaxed text-amber-100" style={{
            color: '#D4AF37',
        ...
        duration: 0.5
          ...
          {manifestoPoints.map((point, index) => <motion.div key={point.title} initial={{
          opacity: 0,
          y: 30
        }} whileInView={{
          opacity: 1,
        ...
        delay: 0.6
          ...
          <Link to="/register">
            <Button size="lg" className="bg-[#D4AF37] hover:bg-[#D4AF37]/90 text-[#050505] font-bold text-sm uppercase tracking-[0.1em] px-10 py-6 shadow-lg shadow-[#D4AF37]/20 transition-all duration-300 hover:shadow-[#D4AF37]/40 group">
              Join the Movement
