      ...
      <div className="flex items-center justify-between h-16 px-4 md:px-6">
        ...
        <Link to="/dashboard" className="flex items-center gap-2 hover:opacity-90 transition-opacity">
          <img 
            ...
            className="w-9 h-9 rounded-full drop-shadow-[0_0_8px_rgba(212,175,55,0.4)] object-fill" 
            src="/lovable-uploads/9d70b725-aecc-4211-9394-d4faafaab49f.png" 
          />
        ...
        {/* Center: Live Ticker - Hidden on mobile */}
        ...
        <div className="flex md:hidden items-center gap-2">
          ...
          <Button 
            onClick={onDepositClick}
            size="sm"
            className="bg-[#00FF41] hover:bg-[#00FF41]/90 text-[#050505] font-bold uppercase text-[10px] tracking-wider min-h-[44px] px-3"
          >
            <Wallet className="w-4 h-4" />
          </Button>
          
          {/* Hamburger Menu */}
          <MobileNavMenu onDepositClick={onDepositClick} />
        </div>
      </div>
    </nav>
  );
