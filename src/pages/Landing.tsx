...
// 3D Floating Membership Card Component
function FoundingAlphaCard() {
  ...
  return (
    <motion.div
      className="relative w-[340px] md:w-[400px] h-[220px] md:h-[260px] cursor-pointer mx-auto perspective-1000"
    ...
    >
      {/* Card Shadow */}
      <div className="absolute inset-0 bg-black/40 rounded-2xl blur-2xl translate-y-4 scale-95" />
      
      {/* Card Body - Black Titanium Effect */}
      <div 
      ...
      >
        ...
        {/* Alpha Logo Watermark */}
        <div className="absolute top-4 right-4 opacity-20">
          <span className="text-6xl font-bold text-[#D4AF37]">α</span>
        </div>
        ...
        <div className="relative z-10 p-6 md:p-8 h-full flex flex-col justify-between">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-1">
              <div className="w-8 h-5 rounded bg-gradient-to-br from-[#D4AF37] to-[#8B7500]" />
              <div className="w-8 h-5 rounded bg-gradient-to-br from-[#D4AF37]/50 to-[#8B7500]/50 -ml-4" />
            </div>
          </div>
          
          {/* Member Info - Embossed Gold Text Effect */}
          <div className="space-y-1">
            <p className="text-[10px] uppercase tracking-widest text-gray-500">Member Name</p>
            <h3 
              className="text-2xl md:text-3xl font-bold tracking-wide"
              style={{
                color: '#D4AF37',
                textShadow: '0 1px 0 #8B7500, 0 2px 4px rgba(0,0,0,0.5)',
              }}
            >
              JUAN DELA CRUZ
            </h3>
          ...
          <div className="flex items-end justify-between">
            ...
            <div className="text-right">
              ...
              <p className="text-sm font-semibold text-[#D4AF37]">ACTIVE</p>
            </div>
          </div>
        </div>
